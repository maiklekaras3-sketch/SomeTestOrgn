...
import (
	...
	"github.com/stainless-sdks/stnlss_test-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	if userAgent != fmt.Sprintf("StnlssTest/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Client.V1.Accounts.AccountID.Firewall.AccessRules.New(context.Background(), stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParams{
		Configuration: stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParamsConfiguration{
			Target: "ip",
			Value:  "value",
		},
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Client.V1.Accounts.AccountID.Firewall.AccessRules.New(cancelCtx, stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParams{
		Configuration: stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParamsConfiguration{
			Target: "ip",
			Value:  "value",
		},
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Client.V1.Accounts.AccountID.Firewall.AccessRules.New(deadlineCtx, stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParams{
			Configuration: stnlsstest.ClientV1AccountAccountIDFirewallAccessRuleNewParamsConfiguration{
				Target: "ip",
				Value:  "value",
			},
